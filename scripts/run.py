...
def apply_shadow_push(img):
    """
    Non-linear LUT: crushes pixels below 130 toward black.
    Pixels >= 130 pass through unchanged — preserves fur and highlights.
    Creates dense shadow clustering without touching mid-tones.
    """
...
def process_image(input_path, output_path):
    ...
    pushed    = apply_shadow_push(sharpened)
 
    print("  Running JJN dithering...")
    dithered = jjn_dither(pushed)
